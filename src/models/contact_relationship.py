...
class ContactRelationship(Base):
    ...
    contact1 = relationship(
        "Contact", foreign_keys=[contact_id_1], backref="relationships_as_contact1"
    )
    contact2 = relationship(
        "Contact", foreign_keys=[contact_id_2], backref="relationships_as_contact2"
    )
